    ...
    return (
        <ul className='flex flex-row justify-around border border-y-black bg-gray-200 font-semibold h-[5vh] items-center text-2xl'>
            ...
            <div className="box flex flex-row space-x-6">
                ...
                <Link className='' target='_blank' to='https://github.com/kartik-212004'><span>
                ...
                <Link target='_blank' to={'https://www.linkedin.com/in/kartikbhatt2004/'}>
                    <span>
                ...
                <Link target='_blank' to={'https://www.instagram.com/karrtikbhatt/'}>
                    <span>
